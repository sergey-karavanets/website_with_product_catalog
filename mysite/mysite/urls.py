...
from goods.views import create_product, create_category, category_view, product_detail_view, update_product, \
    delete_product, search_results, category_detail_view
